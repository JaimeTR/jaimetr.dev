                ...
                >
                    <figure className="w-full rounded-3xl overflow-hidden">
                        <img
                            ...
                            alt={language === 'en' && sorted[0].title_en ? sorted[0].title_en : sorted[0].title}
                            loading="lazy"
                        />
                    </figure>
                    <div className="p-6">
                        <h1 className="font-bold text-lg text-primary-700 dark:text-primary-400">{language === 'en' && sorted[0].title_en ? sorted[0].title_en : sorted[0].title}</h1>
                        <p className="line-clamp-3 mt-4 text-dark-700 dark:text-dark-200">
                            {language === 'en' && sorted[0]?.content?.description_en ? sorted[0].content.description_en : sorted[0].content.description}
                        </p>
                    ...
                    <span className="absolute top-4 left-4 backdrop-blur-md bg-dark-600/50 py-1 px-2 rounded-full z-10 text-sm font-semibold text-dark-100 ">
                        {language === 'en' && sorted[0].category_en ? sorted[0].category_en : sorted[0].category}
                    </span>
                </Link>
                <Link
                ...
                >
                    <figure className="w-full rounded-3xl overflow-hidden">
                        <img
                            ...
                            alt={language === 'en' && sorted[1].title_en ? sorted[1].title_en : sorted[1].title}
                            loading="lazy"
                        />
                    </figure>
                    <div className="p-6">
                        <h1 className="font-bold text-lg text-primary-700 dark:text-primary-400">{language === 'en' && sorted[1].title_en ? sorted[1].title_en : sorted[1].title}</h1>
                        <p className="line-clamp-3 mt-4 text-dark-700 dark:text-dark-200">
                            {language === 'en' && sorted[1]?.content?.description_en ? sorted[1].content.description_en : sorted[1].content.description}
                        </p>
                        <ul className="flex gap-1 flex-wrap text-sm mt-4">
                    ...
                    <span className="absolute top-4 left-4 backdrop-blur-md bg-dark-600/50 py-1 px-2 rounded-full z-10 text-sm font-semibold text-dark-100 ">
                        {language === 'en' && sorted[1].category_en ? sorted[1].category_en : sorted[1].category}
                    </span>
                </Link>
                ...
                >
                    <figure className="w-full rounded-3xl overflow-hidden md:w-1/2 md:h-full">
                        <img
                            ...
                            alt={language === 'en' && sorted[2].title_en ? sorted[2].title_en : sorted[2].title}
                            loading="lazy"
                        />
                    </figure>
                    <div className="p-6 md:w-1/2">
                        <h1 className="font-bold text-lg text-primary-700 dark:text-primary-400">{language === 'en' && sorted[2].title_en ? sorted[2].title_en : sorted[2].title}</h1>
                        <p className="line-clamp-3 mt-4 text-dark-700 dark:text-dark-200">
                            {language === 'en' && sorted[2]?.content?.description_en ? sorted[2].content.description_en : sorted[2].content.description}
                        </p>
                        <ul className="flex gap-1 flex-wrap text-sm mt-4">
                    ...
                    <span className="absolute top-4 left-4 backdrop-blur-md bg-dark-600/50 py-1 px-2 rounded-full z-10 text-sm font-semibold text-dark-100 ">
                        {language === 'en' && sorted[2].category_en ? sorted[2].category_en : sorted[2].category}
                    </span>
                </Link>
            </div>
